...
Object.assign(exports, { splitSongDI, splitSongDW, splitSongMOD, splitSongRH, splitSongST3, splitSongTFMX });
...
function splitSongST3(song, data) {
	...
	return [0, ...Array.from(orders).map((order, i) => order === 254 ? i+1 : null).filter(s => s != null)];
}
